    ...
    ej.widget("ejDropDownList", "ej.DropDownList", {
        ...
        enable: function () {
            if (this._visibleInput.hasClass("e-disable")) {
                ...
                this.model.enabled = true;
				 if (this.model.multiSelectMode == "visualmode") this.wrapper.removeClass("e-disable");
                ...
                if (this.model.multiSelectMode == "visualmode" && this._ulBox) this._ulBox.removeClass("e-disable");
            }
            this._wireEvents();
        ...
        disable: function () {
            if (!this._visibleInput.hasClass("e-disable")) {
				...
				if (this.model.multiSelectMode == "visualmode") this.wrapper.addClass("e-disable");
                ...
                if (this.model.multiSelectMode == "visualmode" && this._ulBox) this._ulBox.addClass("e-disable");
                //Element not Maintain in Multiselection
