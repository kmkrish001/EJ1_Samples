...
(function ($, ej, undefined) {
    ...
    ej.widget("ejColorPicker", "ej.ColorPicker", {
        ...
        _selectEvent: function () {
            if (this._previousColor !== this._tempValue || this._tempOpacity !== this._previousOpacity || this._isApplyBtnClick) {
                this.value(this._tempValue);
                if (this.element.is("input")) this._updateValue();
                this.element.val(this.value());
                this._trigger("select", { value: this.value(), RGBA: this.rgb });
                this._previousColor = this._tempValue;
                this._isApplyBtnClick = false;
            }
        },
